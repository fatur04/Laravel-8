        ...
        <tbody>
            ...
            @foreach ($logs as $key => $data)
                <tr>
                    ...
                    <td>{{ $data->tglmasuk }} | {{ $data->jammasuk }}</td>
                    <td>
                        @if ($data->jamkeluar == null)
                            <i class="btn btn-danger">Belum Absen</i>
                        @endif
                        {{ $data->tglkeluar }} | {{ $data->jamkeluar }}
                    </td>
                    <td>
                        @if ($data->jamkeluar == null)
                            <a href="/absenkeluar/simpan/{{ $data->id }} " class="btn btn-success">Absen Keluar</a>
                        @endif
                            <a href="/absenkeluar/detail/{{ $data->id }} " class="btn btn-primary">Detail</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
